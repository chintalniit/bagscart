...
<div class="span9 margin-left10" ng-app="addToCartApp">
	 <div class="row margin-left25" ng-controller = "addToCartCtrl" ng-init="retrieveCart('${cartId}')">
        <table class="table table-bordered table-striped fs13" >
		  <thead>
			...
			<tbody>
				...
				data:  {{items.item.product_id}}
					 	<td class="span1"><img src="/bagscart/resources/images/{{items.item.product_id}}.jpg" style="width: 100px;height: 100px" alt="image"/></td>
          ...
          <div class="row">
		  <div class="span3">
             <a href="<spring:url value="/CustomerCheck" />" class="btn btn-primary center">Continue Shopping</a>
			</div>	
			<div class="span3">
...
<script src="http://ajax.googleapis.com/ajax/libs/angularjs/1.4.2/angular.min.js"></script>
    ...
    cartApp.controller("addToCartCtrl", function ($scope, $http){
        ...
        $scope.removeItemFromCart = function (itemId) {
            ...
            $http.put('http://localhost:8080/bagscart/usercart/cart/removeItem/'+itemId).success(function (data) {
        ...
        $scope.addItemToCart = function (itemId) {
        	 alert("test");
            $http.put('http://localhost:8080/bagscart/usercart/cart/addItem/'+itemId).success(function () {
        ...
        $scope.refreshCartItems = function () {
            ...
            $http.get('http://localhost:8080/bagscart/usercart/cart/refreshCart/'+$scope.cartId).success(function (data) {
               $scope.cart=data;
            });
        };
        ...
        $scope.clearCartItems = function () {
        	$http['delete']('http://localhost:8080/bagscart/usercart/cart/clearCartItems/'+$scope.cartId).success(function (data) {$scope.refreshCartItems()});
        };
    });
</script>
