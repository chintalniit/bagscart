...
<li class=""><a href="CustomerCheck"><span class="glyphicon glyphicon-log-in" >Login</span></a>
 ...
 <li class="nav-item ">
          <li class="active "><a href="customerSignUp"><span class="glyphicon glyphicon-user" >SignUp</span> </a>
	  </li>
 <li class="nav-item ">
  ...
  <div class="row">
        <div class="col-md-6 col-md-offset-3">
            <form:form action="SignUp" method="POST" accept-charset="utf-8" class="form" role="form" commandName="usersDetail">   
                    <img src="resources/images/register-now.png" style="width:600px;height:300px">
