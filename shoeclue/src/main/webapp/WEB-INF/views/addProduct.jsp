...
<div>
<center><img src="resources/images/our-products.png" style="width: 300px; height: 100px"></center>
</div>
<div>
<hr></hr>
</div>
...
<form:option value="Bags"></form:option>
...
<form:option value="Shoulder Bags"></form:option>
<form:option value="HandBags"></form:option>
<form:option value="Wallets"></form:option>
</form:select></td>
</tr>
<tr><td><br></br></td></tr>
...
<form:option value="Sparx">Fastrack</form:option>
